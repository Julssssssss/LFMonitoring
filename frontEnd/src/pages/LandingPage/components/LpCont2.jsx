    ...
    <>
      <div className="relative flex flex-col text-white overflow-hidden w-screen h-auto pb-[6.5rem] sm:pb-[7rem] md:pb-[10rem] lg:pb-[16rem] xl:pb-[23rem] 2xl:pb-[24rem] 3xl:pb-[21rem]">
        <div className="relative w-screen flex flex-col space-y-[0.5rem] items-center mt-[4rem] text-white font-poppins text-center sm:mt-[5rem] md:mt-[5.5rem] lg:mt-[8rem] lg:-left-[4rem] lg:flex-row xl:mt-[14rem] 2xl:mt-[20rem]">
          ...
          <img src="https://res.cloudinary.com/dxjpbwlkh/image/upload/v1709018898/Assets/Untitled_design_1_unj1ln.png" alt="model2" className="h-[10rem] w-[10rem] absolute z-10 -left-[3rem] bottom-[1rem] opacity-20 md:h-[15rem] md:w-[15rem] md:-left-[3.5rem] lg:w-[17rem] lg:h-[17rem] lg:-bottom-[10rem] lg:left-[20rem] xl:w-[25rem] xl:h-[25rem] xl:-bottom-[21rem] 2xl:-bottom-[15rem] 2xl:left-[32rem] 2xl:h-[27rem] 2xl:w-[27rem]"/>
