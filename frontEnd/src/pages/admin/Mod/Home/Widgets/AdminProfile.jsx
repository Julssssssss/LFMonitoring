    ...
    return (
      ...
      {/* close button */}
          <div className="bg-[#0d1832] flex flex-row">
            <Link to='/Admin/Dashboard'>
              <button className='mt-[1rem] ml-[1rem]'>
                <svg className="w-[2rem] h-[2rem] xl:w-[4rem] xl:h-[4rem]" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 27 26" fill="none">
          ...
          <div className="bg-[#0d1832] font-poppins md:text-[1.5rem] h-full flex flex-col items-center">
            ...
            {/* USER DATA */}
            <div className="bg-[#003985] h-auto p-[2rem] leading-[2rem] w-auto mt-[5rem] text-white p-[1rem] justify-center flex flex-col z-20 rounded-xl lg:text-[1.1rem] lg:w-[25rem] xl:w-[25rem] xl:h-[15rem] xl:text-[1.3rem] 2xl:w-[30rem] 2xl:h-[25rem] 2xl:text-[2rem] xl:mt-[8.5rem]">
              <b>Name:</b> {info.Name}  <br/><br/>
              <b>Email:</b> {info.Email}
            </div>
            {/* yellow designs */}
            <div className="absolute rounded-tr-full left-0 top-[19rem] bg-yellow-400 w-[14rem] h-[4.6rem] z-10 xsm:top-[21rem] sm:h-[6rem] sm:w-[21rem] md:h-[7rem] md:w-[30rem] xl:h-[9rem] xl:w-[45rem] xl:top-[24rem] 2xl:top-[28rem] 2xl:w-[52rem]"></div>
            <div className=" absolute rounded-bl-full right-0 top-[27.5rem] bg-yellow-400 w-[14rem] h-[4.6rem] z-10 xsm:top-[31rem] sm:h-[6rem] sm:w-[20rem] md:h-[7rem] md:w-[30rem] lg:top-[33rem] xl:h-[9rem] xl:w-[45rem] xl:top-[36rem] 2xl:top-[50rem] 2xl:w-[52rem]"></div>
