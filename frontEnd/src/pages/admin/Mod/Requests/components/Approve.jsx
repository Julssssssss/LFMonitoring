    ...
    <>
      <div>
        <button
          onClick={openPopup}
          type="button"
          className="bg-[#F9D62B] w-[5rem] rounded-xl py-[0.2rem]"
        >
          Approve
        </button>
      </div>
      ...
      {showConfirmation && (
        <div className="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-black bg-opacity-50">
          ...
          <div className="flex flex-col space-y-[3rem] justify-center items-center">
            <div className='text-[1.5rem] space-y-[1rem] text-white'>
            ...
            <button onClick={sendToArchive} className="bg-[#F9D62B] text-[1.5rem] text-black p-2 rounded-2xl w-[10rem] font-bold">
              APPROVE
            </button>
          </div>
        </div>
