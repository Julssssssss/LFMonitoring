  ...
  return (
    <>
        <div className="flex flex-col h-screen w-[7.5rem] border-r-[0.5rem] border-[#134083] rounded-r-[5rem] space-y-[2rem] bg-[#0D1832] items-center overflow-x-hidden">
            ...
            <div key={index}> 
                <Link to={nav.to}>
                    <button className='w-[2.5rem] h-[2.5rem]'>
                        {nav.svg}
                    </button>
                </Link>
            </div>
