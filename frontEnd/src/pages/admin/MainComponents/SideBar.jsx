        ...
        return filteredButtons.map((nav, index) => {
            return (
                <Link to={nav.to} key={index} className="group flex items-center justify-center border-b-[0.1rem] border-white rounded-xl w-[7rem] h-[2.5rem] xsm:w-[9rem] md:w-[12rem] md:h-[3.5rem] lg:w-0">
                    <button className='relative flex space-x-[2rem] text-white items-center stroke-white hover:stroke-[#F9D62B] text-[0.6rem] xsm:text-[0.7rem] md:text-[1rem] font-bold justify-start lg:justify-center'>
                        ...
                        {/*for tooltip*/}
                       {/* <span className="font-poppins fixed z-80 whitespace-nowrap left-[3rem] md:left-[15rem] lg:left-0 flex scale-0 rounded bg-gray-800 p-[1.1rem] md:p-[3rem] justify-center text-[1rem] md:text-[4rem] text-white group-hover:scale-50 w-[8rem] md:w-[15rem]">{nav.name}</span> */}
                    </button>
                </Link>
            );
        });
    ...
    <div className="drawer-side">
        ...
        <ul className=" space-y-[1rem] menu p-2 w-[50%] border-r-[0.2rem] border-[#134083] rounded-r-[6rem] md:rounded-r-[10rem] lg:rounded-r-[6rem] h-screen bg-[#0D1832] flex flex-col items-center pt-[2rem] lg:w-[8rem] xl:w-[10rem]">
            <img className="w-[4rem] h-[4rem] md:w-[6rem] md:h-[6rem] lg:w-[5rem] lg:h-[5rem] xl:w-[7rem] xl:h-[7rem]" src={'https://iieecsc.files.wordpress.com/2021/09/rizal_technological_university-1.png'} />
                ...
                <Link to={'/admin/HlpDocs'} className="absolute bottom-[4.5rem] lg:bottom-[3rem] flex items-center justify-center border-b-[0.1rem] border-white rounded-xl w-[7rem] h-[2.5rem] xsm:w-[9rem] md:w-[12rem] md:h-[3.5rem] lg:w-0">
