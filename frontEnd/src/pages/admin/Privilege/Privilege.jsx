...
const Privilege = () => {
  ...
  return (
    <div className='flex flex-row h-screen w-screen bg-[#17394C] overflow-x-hidden overflow-y-hidden'>
      <Sidebar />
      <div className="flex flex-col self-center p-[1rem] md:p-[2rem] h-full w-screen bg-[#0D1832] border-[#134083]">
        <div className="flex flex-col justify-between mt-[0.5rem] mb-[1rem] text-white whitespace-nowrap px-[1rem]">
          <div className='font-poppins ml-[2rem] md:ml-[5rem] md:text-[2rem]'>
            PRIVILEGE
          </div>   
        </div>
        <div className="self-center h-full w-screen px-[1rem] md:px-[2rem]">
            ...
            <div className='flex flex-row space-x-[1.5rem] items-center top-[8rem] relative'>
              <div className="relative">
                <div className='flex flex-row space-x-[0.5rem] items-center'>
                  <input type='text' 
                    className="text-justify rounded-xl w-full h-[2rem] md:h-[2.5rem] md:w-[20rem] font-poppins bg-[#17394C] text-[0.7rem] md:text-[1rem] p-2 text-white"
                  ...
                  <button
                    onClick={dropResult}
                    className="w-[7rem] h-[1.5rem] md:h-[2rem] md:text-[1.5rem] text-black font-poppins flex items-center text-[1rem] justify-center bg-[#F9D62B] rounded-2xl hover:bg-[#134083] hover:text-white hover:border-white hover:border-[0.1rem]"
                  >
                    Find
                  </button>
                </div>
                {isOpen && (
                  <div className="flex flex-col mt-[2rem] space-y-[1rem] p-[1rem] text-[1.5rem] drop-shadow-2xl text-white rounded-xl shadow-md bg-[#17394C] w-[16.8rem] md:w-[28rem] px-[1rem] h-auto">
                    <div className='flex flex-row justify-between text-[0.7rem] md:text-[1.5rem]'>
                      {userData ? (
                        <>
                    ...
                    {userData && (
                      <div className='flex flex-row space-x-[1rem] justify-center font-poppins text-black font-bold text-[0.6rem] md:text-[1rem] items-center'>
                        <button className='bg-[#F9D62B] rounded-full w-[11rem] h-[1.5rem] md:h-[2rem]'
                          onClick={() => {setRole(0);}}>
                          User
                        </button>
                        <button className='bg-[#F9D62B] rounded-full w-[11rem] h-[1.5rem] md:h-[2rem]'
