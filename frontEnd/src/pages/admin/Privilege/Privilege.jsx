            ...
            <div className='flex flex-row space-x-[1.5rem] items-center top-[8rem] relative'>
              <div className="relative">
                <div className='flex flex-row space-x-[0.5rem] items-center'>
                  ...
                  <button
                    onClick={dropResult}
                    className="w-[7rem] h-[1.5rem] text-black font-poppins flex items-center text-[1rem] justify-center bg-[#F9D62B] rounded-2xl hover:bg-[#134083] hover:text-white hover:border-white hover:border-[0.1rem]"
                  >
                    Find
                  </button>
                </div>
