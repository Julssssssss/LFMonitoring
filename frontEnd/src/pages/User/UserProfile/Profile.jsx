  ...
  return (
    ...
    {/* close button */}
        <div className="bg-[#0d1832] flex flex-row">
          <Link to='/Dashboard'>
            <button className='mt-[1rem] ml-[1rem] w-[2rem] h-[2rem] xl:w-[2.5rem] xl:h-[2.5rem] 2xl:h-[3.5rem] 2xl:w-[3.5rem]'>
        ...
        <div className="bg-[#0d1832] font-poppins h-auto flex flex-col items-center 2xl:h-screen">
          {/* USER IMAGE */}
          <img className='rounded-full border-8 mt-10 w-[10rem] h-[10rem] border-yellow-400 sm:w-[11rem] sm:h-[11rem] xl:w-[12.5rem] xl:h-[12.5rem]' src={User[0].picture}></img>
          {/* USER DATA */}
          <div className="bg-[#003985] h-[10rem] leading-[1rem] w-[15rem] mt-[5rem] text-white p-[1rem] justify-center flex flex-col z-20 rounded-xl sm:w-[16rem] sm:h-[11rem] sm:mt-[6rem] md:h-[12rem] md:w-[20rem] md:mt-[6.5rem] xl:w-[25rem] xl:h-[15rem] xl:text-[1.3rem] 2xl:h-[20rem] 2xl:w-[30rem] 2xl:text-[1.5rem] 2xl:leading-[1.5rem] xl:mt-[8.5rem]">
            <b>Name:</b> {User[0].user.Name}  <br/><br/>
            <b>Email:</b> {User[0].user.Email}
          </div>
          {/* yellow designs */}
          <div className="absolute rounded-tr-full left-0 top-[19rem] bg-yellow-400 w-[14rem] h-[4.6rem] z-10 sm:top-[21rem] md:h-[6rem] md:w-[21rem] lg:h-[7rem] lg:w-[30rem] xl:h-[9rem] xl:w-[45rem] xl:top-[24rem] 2xl:h-[11rem] 2xl:w-[60rem]"></div>
          <div className=" absolute rounded-bl-full right-0 top-[27.5rem] bg-yellow-400 w-[14rem] h-[4.6rem] z-10 sm:top-[31rem] md:h-[6rem] md:w-[20rem] lg:h-[7rem] lg:w-[30rem] xl:h-[9rem] xl:w-[45rem] xl:top-[36rem] 2xl:h-[11rem] 2xl:w-[60rem] 2xl:top-[40rem]"></div>
          <div className="mt-[7rem] mb-[8rem] sm:mt-[8rem] md:mt-[9rem]">
            <Logout />
          </div>
        </div>
    </>
