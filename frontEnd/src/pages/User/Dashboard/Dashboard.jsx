...
const Dashboard = () => {
  ...
  return (
    ...
    <div className="relative z-0 flex flex-col space-y-[1rem] bg-[#0d1832] w-auto p-[1.5rem] pb-[0.8rem] min-h-screen font-poppins overflow-x-hidden 3xl:p-[2rem]">
      ...
      <div className="flex flex-col items-center justify-center z-30 w-full h-[4rem] 2xl:h-[6.5rem] rounded-xl bg-[#134083] bg-opacity-75 self-center items-center 2xl:h-[4rem] 2xl:space-y-[0.3rem]">
