  ...
  return (
    <div className="relative font-poppins overflow-hidden ">
      ...
      <div className="bg-[#0d1832] flex flex-row ">
        <Link to='/Dashboard'>
          <button className='mt-[1rem] ml-[1rem] w-[2rem] h-[2rem] xl:w-[3rem] xl:h-[3rem] 2xl:w-[4rem] 2xl:h-[4rem]'>
        ...
        <div className="bg-[#0d1832] h-auto flex flex-col items-center justify-center md:h-screen xl:space-y-[2rem] 2xl:space-y-[3.5rem] overflow-hidden">
          {/* IMG */}
          <div className="flex flex-col items-center justify-center md:flex-row md:space-x-[2rem] xl:space-x-[2.5rem]">
            <Carousel />
            {/* DIV FOR CONTAINER OF CONTENTS */}
            <div className=" whitespace-nowrap text-center p-[1.2rem] flex flex-col items-center justify-center bg-[#17394c] h-auto w-[19rem] sm:w-[21rem] lg:w-[22rem] lg:h-auto xl:w-[25rem] xl:text-[1.3rem] 2xl:w-[34rem] 2xl:text-[2rem] mt-[3rem] mb-[4rem] rounded-lg text-white">
              {/* title */}
              <div>{data.nameItem}</div>

              {/* desc container */}
              <div className="mt-[1.5rem] w-full h-auto shadow-md rounded-sm shadow-[#0d1832] overflow-clip">
                {/* desc */}
          ...
          <img src="https://res.cloudinary.com/dxjpbwlkh/image/upload/v1709214386/Assets/Polygon_11_qhnrk7.png" alt="triangle1" className="absolute top-[6rem] -left-[2.5rem] h-[5rem] w-[5rem] md:h-[6rem] md:w-[6.5rem] xl:h-[8rem] xl:w-[8rem] 2xl:h-[12rem] 2xl:w-[12rem]"/>
          <img src="https://res.cloudinary.com/dxjpbwlkh/image/upload/v1709214386/Assets/Group_6_r8nwi5.png" alt="triangle2" className="absolute -bottom-[4.5rem] -right-[4rem] w-[12.5rem] h-[10rem] md:w-[14rem] md:h-[12rem] xl:h-[17rem] xl:w-[19rem] 2xl:h-[23rem] 2xl:w-[25rem]" />
          {/* request button */}
